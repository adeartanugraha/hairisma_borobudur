...
public class DBHandler implements I_DBType {
      ...
      /**
     * @return the systemDebugModePersistent
     */
    public static boolean isDebugModePersistent() {
        return debugModePersistent;
    }

    /**
     * @return the systemDebugModeController
     */
    public static boolean isDebugModeController() {
        return debugModeController;
    }

    /**
     * @return the debugModeView
     */
    public static boolean isDebugModeView() {
    ...
    private static boolean debugModePersistent = false; // add by kartika 2022-10-14
    private static boolean debugModeController = false;// add by kartika 2022-10-14
    private static boolean debugModeView = false;// add by kartika 2022-10-14
    ...
    protected static void loadConfig_online() // for online
        ...
        if (!configLoaded) {
            ...
            try {
                ...
                configValue = configReader.getConfigValue("debugmodepersistent");
