...
public class DBConfigReader {
    ...
    public static final int SYSTEM             = 3;
        public static final int DEBUG_PERSISTENT = 0;  
        public static final int DEBUG_CONTROLLER = 0;  
        public static final int DEBUG_VIEW   = 0; 
...
//        "database","logs","format"
    ...
    public static String xmlPcDataSystem[] = { // add by kartika 2022-10-14
        "debugmodepersistent","debugmodecontroller","debugmodeview"
    };
            ...
            for (int i = 0; i < xmlSubRoot.length; i++) {                                
                ...
                switch (i) {
                    ...
                    case FORMAT   :
                         ...
                         break;  
                    case SYSTEM   : // add by kartika 2022-10-14
                        try{
                         for(int j=0; j<xmlPcDataSystem.length; j++){                            
                             Element pcDataElement = subrootElement.getChild(xmlPcDataSystem[j]);
                             this.configStorage.put(xmlPcDataSystem[j], pcDataElement.getText());                             
                         }} catch(Exception exc){
