            ...
            */
            while (rs.next()) {
                ...
                if (emp!=null && emp.getResigned() == 1){
                    ...
                    if (emp!=null && emp.getStatusPensiunProgram() == 1){
                        /* JHT = 1 | PENSION = 1 */
                        if (compName.equals("ASTEK")){
                            salaryLevelDetail.setFormula(rs.getString(PstSalaryLevelDetail.fieldNames[PstSalaryLevelDetail.FLD_FORMULA]));
                        }
...
//    
//        public static Vector listComponentVer1(int limitStart, int recordToGet, String salaryLevel, int compType, String addWhere, Employee employee) {
//       
//        Vector lists = new Vector();
//        DBResultSet dbrs = null;
//        try {
...
//                salaryLevelDetail.setComponentId(rs.getLong(PstSalaryLevelDetail.fieldNames[PstSalaryLevelDetail.FLD_COMPONENT_ID]));
//                //resultToObject(rs, salaryLevelDetail);
//                if (employee!=null && employee.getResigned() == 1){
//                    /* JHT = 0 | PENSION = 0 */
//
//                    if (compName.equals("ASTEK")){
//                    salaryLevelDetail.setFormula("=0");
...
//                    
//                } else {
//                    if (employee!=null && employee.getStatusPensiunProgram() == 1){
//                        /* JHT = 1 | PENSION = 1 */
//                        if (compName.equals("ASTEK")){
//                            salaryLevelDetail.setFormula(rs.getString(PstSalaryLevelDetail.fieldNames[PstSalaryLevelDetail.FLD_FORMULA]));
//                        }
