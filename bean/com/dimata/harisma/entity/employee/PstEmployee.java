...
public class PstEmployee extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    public static final int FLD_NAMA_REKENING = 94;
    public static final int FLD_NAMA_BANK = 95;
    ...
    public static Employee fetchExc(long oid) throws DBException {
        try {
            ...
            employee.setNamaRekening(pstEmployee.getString(FLD_NAMA_REKENING));
    ...
    public static Hashtable fetchExcHashtable(long oid) throws DBException {
        ...
        try {
            ...
            employee.setNoKK(pstEmployee.getString(FLD_NO_KK));
            hashtableEmp.put(PstEmployee.fieldNames[PstEmployee.FLD_NO_KK], (employee.getNoKK()!= null?employee.getNoKK():""));
            
            employee.setNamaRekening(pstEmployee.getString(FLD_NAMA_REKENING));
            hashtableEmp.put(PstEmployee.fieldNames[PstEmployee.FLD_NAMA_REKENING], (employee.getNamaRekening()!= null?employee.getNamaRekening():""));
            
            employee.setNamaBank(pstEmployee.getString(FLD_NAMA_BANK));
            hashtableEmp.put(PstEmployee.fieldNames[PstEmployee.FLD_NAMA_BANK], (employee.getNamaBank()!= null?employee.getNamaBank():""));
            //end add
    ...
    public static long insertExc(Employee employee) throws DBException {
        try {
            ...
            pstEmployee.setString(FLD_NAMA_REKENING, employee.getNamaRekening());
    ...
    public static void resultToObject(ResultSet rs, Employee employee) {
        try {
            ...
            employee.setNamaRekening(rs.getString(fieldNames[FLD_NAMA_REKENING]));
