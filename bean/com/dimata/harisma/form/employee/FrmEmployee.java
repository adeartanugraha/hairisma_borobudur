...
public class FrmEmployee extends FRMHandler implements I_FRMInterface, I_FRMType {
    ...
    public static final int FRM_FIELD_NAMA_REKENING = 92;
    public static final int FRM_FIELD_NAMA_BANK = 93;
    ...
    public void requestEntityObject(Employee employee) {
        try {
            ...
            employee.setNamaRekening(getString(FRM_FIELD_NAMA_REKENING));
