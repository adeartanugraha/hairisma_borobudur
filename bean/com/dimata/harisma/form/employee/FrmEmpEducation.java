...
public class FrmEmpEducation extends FRMHandler implements I_FRMInterface, I_FRMType {
    ...
    public static final int FRM_FIELD_INSTITUTION = 9;
    public static String[] fieldNames = {
        ...
        "FRM_FIELD_EDUCATION_DESC","FRM_FIELD_POINT", "FRM_FIELD_INSTITUTION_ID","FRM_FIELD_INSTITUTION"};
    public static int[] fieldTypes = {
        TYPE_LONG, TYPE_LONG + ENTRY_REQUIRED,
        TYPE_LONG + ENTRY_REQUIRED, TYPE_INT + ENTRY_REQUIRED,
        TYPE_INT + ENTRY_REQUIRED, TYPE_STRING, TYPE_STRING, TYPE_FLOAT, TYPE_LONG, TYPE_STRING
    };
    ...
    public void requestEntityObject(EmpEducation empEducation) {
        try {
            ...
            empEducation.setInstitution(getString(FRM_FIELD_INSTITUTION));
        } catch (Exception e) {
