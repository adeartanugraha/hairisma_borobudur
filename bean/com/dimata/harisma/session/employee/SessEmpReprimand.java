...
public class SessEmpReprimand {
    ...
    public static Vector getEmployeeReprimand(SrcEmpReprimand srcReprimand, int start, int recordToGet) {
        ...
        try {
            ...
            sql.append(" RPM.").append(PstEmpReprimand.fieldNames[PstEmpReprimand.FLD_VALIDITY]).append(",");
            ...
            {       
                ...
                rep.setReprimandDate(rs.getDate(PstEmpReprimand.fieldNames[PstEmpReprimand.FLD_REP_DATE]));
                rep.setValidityDate(rs.getDate(PstEmpReprimand.fieldNames[PstEmpReprimand.FLD_VALIDITY]));
