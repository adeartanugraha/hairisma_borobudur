...
+",PAYGROP."+PstPayrollGroup.fieldNames[PstPayrollGroup.FLD_PAYROLL_GROUP_NAME];
...
+ " LEFT JOIN  " + PstPayrollGroup.TBL_PAYROLL_GROUP + " AS PAYGROP ON (PAYGROP."+PstPayrollGroup.fieldNames[PstPayrollGroup.FLD_PAYROLL_GROUP_ID]+"=EMP."+PstEmployee.fieldNames[PstEmployee.FLD_PAYROLL_GROUP]+" ) ";
...
//                Race race = new Race();
		...
		sessTmpSpecialEmployee.setTaxMarital(rs.getString("MARTAX."+PstMarital.fieldNames[PstMarital.FLD_MARITAL_STATUS]));
                ...
                sessTmpSpecialEmployee.setPayrollGroup(rs.getString("PAYGROP."+PstPayrollGroup.fieldNames[PstPayrollGroup.FLD_PAYROLL_GROUP_NAME]));
