...
public class SessEmpWarning {
    ...
    public static Vector getEmployeeWarning(SrcEmpWarning srcWarning, int start, int recordToGet) {
        ...
        try {
            ...
            sql.append(" WRN.").append(PstEmpWarning.fieldNames[PstEmpWarning.FLD_VALID_UNTIL]).append(",");
            ...
            {       
                ...
                wrn.setValidityDate(rs.getDate(PstEmpWarning.fieldNames[PstEmpWarning.FLD_VALID_UNTIL]));
