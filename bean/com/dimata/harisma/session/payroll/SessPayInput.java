...
public class SessPayInput {
    ...
    public static Vector listPayInput(long departmentName,long companyId,long divisionId, String levelCode, long sectionName, String searchNrFrom, String searchNrTo, String searchName, long periodId, int dataStatus,int isChekedRadioButtonSearchNr,String searchNr,long payrollGroup) {
