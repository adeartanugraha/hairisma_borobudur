...
//            }
     ...
     * @return String of working duration in Hour and Minutes format
     */
    //cara pakainya in jadi out out jadi in dibalik parameternya
    public static String getWorkingBreakDuration(Date dtActualIn, Date dtActualOut) {
        String result = "";
        Date x = new Date();
