...
if(showOvertime==0){
        ...
        if(showOvertime==0){
           totTanpaOvertime=11;
            ...
            ,"Diff Out","Duration","Duration Break","insentif","Ot.Form","Allowance","Paid/Dp","Net.Ot","Reason","Note","Status"
           ...
           String[] tableHeaderNotOT = {
            ...
            "No","Payrol Number","Nama","Company","Division","Departement","Section","Date"
            ,"Schedule","Time In","Time Out","Break Out","Break In","Diff In"
            ,"Diff Out","Duration","Duration Break","Reason","Note","Status"
...
//            }
            ...
            String strDurationBreak = SessEmpSchedule.getWorkingBreakDuration(dateBreakOut, dateBreakIn);
            ...
            cell = row.createCell((short) 16);cell.setCellValue(strDurationBreak);cell.setCellStyle(style2);//duration break
            if(showOvertime==0){
                ...
                cell = row.createCell((short) 17);cell.setCellValue(""+insentif);cell.setCellStyle(style2);//insentif            
                cell = row.createCell((short) 18);cell.setCellValue(oVForm==-1?"-":I_DocStatus.fieldDocumentStatus[oVForm]);cell.setCellStyle(style2);//ot form            
                cell = row.createCell((short) 19);cell.setCellValue(allwance==-1?"-":Overtime.allowanceType[allwance]);cell.setCellStyle(style2);//allowance            
                cell = row.createCell((short) 20);cell.setCellValue(paid==-1?"-":OvertimeDetail.paidByKey[paid]);cell.setCellStyle(style2);//paid/DP            
                cell = row.createCell((short) 21);cell.setCellValue(""+NetOv);cell.setCellStyle(style2);//netOt            
                cell = row.createCell((short) 22);cell.setCellValue(""+reason1st);cell.setCellStyle(style2);//reason            
                cell = row.createCell((short) 23);cell.setCellValue(""+attendanceReportDaily.getNote1st());cell.setCellStyle(style2);//note            
                cell = row.createCell((short) 24);cell.setCellValue(""+attendanceReportDaily.getStatus1st());cell.setCellStyle(style2);//staus            
            }else{
                cell = row.createCell((short) 17);cell.setCellValue(""+reason1st);cell.setCellStyle(style2);//,Reason
                cell = row.createCell((short) 18);cell.setCellValue(""+attendanceReportDaily.getNote1st());cell.setCellStyle(style2);//note            
                cell = row.createCell((short) 19);cell.setCellValue(""+attendanceReportDaily.getStatus1st());cell.setCellStyle(style2);    //status        
