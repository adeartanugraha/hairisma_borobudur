 ...
 * @author IanRizky
 */
public class EmployeeListXLSWIthImage extends HttpServlet {
...
//        srcEmployee = (SrcEmployee) session.getValue(SessEmployee.SESS_SRC_EMPLOYEE);
        ...
        String[] tableHeader = {
            ...
            "NO","FOTO","PAYROLL","FULL NAME", "BARCODE","ID CARD","COMPANY","DIVISION","DEPARTEMENT","SECTION","EMP. CATEGORY"
			...
			/* training */
			, "TRAINING PROGRAM","TRAINER","START DATE","END DATE"
			/* warning */
			, "BREAK DATE", "BREAK FACT", "WARNING DATE", "WARN BY"
			/* reprimand*/
			, "REPRIMAND DATE", "REPRIMAND DESC"
			/* AWARD */
     ...
     if(listEmployee!=null&&listEmployee.size()>0){
        ...
        for (int i = 0; i < listEmployee.size(); i++) {
			...
			Vector listCareer = PstCareerPath.list(0, 0, PstCareerPath.fieldNames[PstCareerPath.FLD_EMPLOYEE_ID]+"="+sessTmpSpecialEmployee.getEmployeeId(), PstCareerPath.fieldNames[PstCareerPath.FLD_WORK_FROM]+" DESC");
			Vector listTraining = PstTrainingHistory.list(0, 0, PstTrainingHistory.fieldNames[PstTrainingHistory.FLD_EMPLOYEE_ID]+"="+sessTmpSpecialEmployee.getEmployeeId(), PstTrainingHistory.fieldNames[PstTrainingHistory.FLD_START_DATE]+" DESC");
			Vector listWarning = PstEmpWarning.list(0, 0, PstEmpWarning.fieldNames[PstEmpWarning.FLD_EMPLOYEE_ID]+"="+sessTmpSpecialEmployee.getEmployeeId(), PstEmpWarning.fieldNames[PstEmpWarning.FLD_BREAK_DATE]+" DESC");
			Vector listReprimand = PstEmpReprimand.list(0, 0, PstEmpReprimand.fieldNames[PstEmpReprimand.FLD_EMPLOYEE_ID]+"="+sessTmpSpecialEmployee.getEmployeeId(), PstEmpReprimand.fieldNames[PstEmpReprimand.FLD_REP_DATE]+" DESC");
			Vector listAward = PstEmpAward.list(0, 0, PstEmpAward.fieldNames[PstEmpAward.FLD_EMPLOYEE_ID]+"="+sessTmpSpecialEmployee.getEmployeeId(), PstEmpAward.fieldNames[PstEmpAward.FLD_AWARD_DATE]+" DESC");
          ...
          try{
           ...
           // row = sheet.createRow((short) (i+1));
			...
			try {
				...
				pictPath = contextPath+"/imgcache/"+sessTmpSpecialEmployee.getEmployeeNum()+".JPEG";
			...
			BufferedImage img = ImageIO.read(new File(pictPath));//resize(new File(pictPath), new Dimension(130, 135));
			...
			my_anchor.setCol2(2);
			my_anchor.setRow2(countRow+1);
			
			/* Invoke createPicture and pass the anchor point and ID */
			HSSFPicture  my_picture = drawing.createPicture(my_anchor, my_picture_id);
			/* Call resize method, which resizes the image */
			//my_picture.resize();
			cell = row.createCell((short) 1);cell.setCellValue("");cell.setCellStyle(style2);    
			...
			cell = row.createCell((short) 3);cell.setCellValue(sessTmpSpecialEmployee.getFullName()!=null&& sessTmpSpecialEmployee.getFullName().length()>0?sessTmpSpecialEmployee.getFullName():"-");cell.setCellStyle(style2);   
            cell = row.createCell((short) 4);cell.setCellValue(sessTmpSpecialEmployee.getBarcodeNumber()!=null&& sessTmpSpecialEmployee.getBarcodeNumber().length()>0?sessTmpSpecialEmployee.getBarcodeNumber():"-");cell.setCellStyle(style2);   
            cell = row.createCell((short) 5);cell.setCellValue(sessTmpSpecialEmployee.getIndentCardNr()!=null&& sessTmpSpecialEmployee.getIndentCardNr().length()>0?sessTmpSpecialEmployee.getIndentCardNr():"-");cell.setCellStyle(style2);   
			...
			cell = row.createCell((short) 92);cell.setCellValue("");cell.setCellStyle(style2);
			cell = row.createCell((short) 93);cell.setCellValue("");cell.setCellStyle(style2);
			
			cell = row.createCell((short) 94);cell.setCellValue("");cell.setCellStyle(style2);
			cell = row.createCell((short) 95);cell.setCellValue("");cell.setCellStyle(style2);
			cell = row.createCell((short) 96);cell.setCellValue("");cell.setCellStyle(style2);
			cell = row.createCell((short) 97);cell.setCellValue("");cell.setCellStyle(style2);
            ...
            cell = row.createCell((short) 98);cell.setCellValue("");cell.setCellStyle(style2);
            cell = row.createCell((short) 99);cell.setCellValue("");cell.setCellStyle(style2);
            cell = row.createCell((short) 100);cell.setCellValue("");cell.setCellStyle(style2);
            cell = row.createCell((short) 101);cell.setCellValue("");cell.setCellStyle(style2);
            //end
           ...
           //}  
			...
			int tmpTraining=countRow;
             if(listTraining!=null && listTraining.size()>0){
                 for(int idxTraining=0; idxTraining<listTraining.size();idxTraining++){
                     TrainingHistory  training = (TrainingHistory)listTraining.get(idxTraining);
						row = sheet.getRow(tmpTraining);
					  if(row==null){
						   row = sheet.createRow((short) (tmpTraining));
						   row.setHeight((short) 400);
						   for(int idx=0;idx<86;idx++){
							  cell = row.createCell((short) idx);cell.setCellValue("");cell.setCellStyle(style2); 
							} 
						   for(int idx=90;idx<102;idx++){
							  cell = row.createCell((short) idx);cell.setCellValue("");cell.setCellStyle(style2); 
							} 
					  }

					cell = row.createCell((short) 86);cell.setCellValue( training.getTrainingProgram() != null ? training.getTrainingProgram()  :"-");cell.setCellStyle(style2);
					cell = row.createCell((short) 87);cell.setCellValue( training.getTrainer()!= null ? training.getTrainer()  :"-");cell.setCellStyle(style2);
					cell = row.createCell((short) 88);cell.setCellValue( training.getStartDate()!= null ? Formater.formatDate(training.getStartDate(), "yyyy-MM-dd")  :"-");cell.setCellStyle(style2);
					cell = row.createCell((short) 89);cell.setCellValue( training.getEndDate()!= null ? Formater.formatDate(training.getEndDate(), "yyyy-MM-dd")  :"-");cell.setCellStyle(style2);
					tmpTraining=tmpTraining+1;
                 }
             }
             /**
              * update by satrya 2013-10-12
              ...
              */
            //if(adaListFamily){
              if(tmpTraining-countRow > addRow){
                     addRow = tmpTraining - countRow;
             }
			  
			
			int tmpWarning=countRow;
             if(listWarning!=null && listWarning.size()>0){
                 for(int idxWarning=0; idxWarning<listWarning.size();idxWarning++){
                     EmpWarning  warning = (EmpWarning)listWarning.get(idxWarning);
						row = sheet.getRow(tmpWarning);
					  if(row==null){
						   row = sheet.createRow((short) (tmpWarning));
						   row.setHeight((short) 400);
						   for(int idx=0;idx<90;idx++){
							  cell = row.createCell((short) idx);cell.setCellValue("");cell.setCellStyle(style2); 
							} 
						   for(int idx=94;idx<102;idx++){
							  cell = row.createCell((short) idx);cell.setCellValue("");cell.setCellStyle(style2); 
							} 
					  }

					cell = row.createCell((short) 90);cell.setCellValue( warning.getBreakDate()!= null ? Formater.formatDate(warning.getBreakDate(), "yyyy-MM-dd")  :"-");cell.setCellStyle(style2);
					cell = row.createCell((short) 91);cell.setCellValue( warning.getBreakFact()!= null ? warning.getBreakFact() :"-");cell.setCellStyle(style2);
					cell = row.createCell((short) 92);cell.setCellValue( warning.getWarningDate()!= null ? Formater.formatDate(warning.getWarningDate(), "yyyy-MM-dd") :"-");cell.setCellStyle(style2);
					cell = row.createCell((short) 93);cell.setCellValue( warning.getWarningBy() != null ? warning.getWarningBy() :"-");cell.setCellStyle(style2);
					tmpWarning=tmpWarning+1;
                 }
             }
              ...
              */
            //if(adaListFamily){
              if(tmpWarning-countRow > addRow){
                     addRow = tmpWarning - countRow;
             }
			  
			  int tmpReprimand=countRow;
             if(listReprimand!=null && listReprimand.size()>0){
                 for(int idxReprimand=0; idxReprimand<listReprimand.size();idxReprimand++){
                     EmpReprimand  reprimand = (EmpReprimand)listReprimand.get(idxReprimand);
						row = sheet.getRow(tmpReprimand);
					  if(row==null){
						   row = sheet.createRow((short) (tmpReprimand));
						   row.setHeight((short) 400);
						   for(int idx=0;idx<94;idx++){
							  cell = row.createCell((short) idx);cell.setCellValue("");cell.setCellStyle(style2); 
							} 
						   for(int idx=96;idx<102;idx++){
							  cell = row.createCell((short) idx);cell.setCellValue("");cell.setCellStyle(style2); 
							} 
					  }

					cell = row.createCell((short) 94);cell.setCellValue( reprimand.getReprimandDate()!= null ? Formater.formatDate(reprimand.getReprimandDate(), "yyyy-MM-dd")  :"-");cell.setCellStyle(style2);
					cell = row.createCell((short) 95);cell.setCellValue( reprimand.getDescription()!= null ? reprimand.getDescription() :"-");cell.setCellStyle(style2);
					tmpReprimand=tmpReprimand+1;
                 }
             }
              ...
              */
            //if(adaListFamily){
              if(tmpReprimand-countRow > addRow){
                     addRow = tmpReprimand - countRow;
             }
			  
			  int tmpAward=countRow;
             if(listAward!=null && listAward.size()>0){
                 for(int idxAward=0; idxAward<listAward.size();idxAward++){
                     EmpAward  award = (EmpAward)listAward.get(idxAward);
						row = sheet.getRow(tmpAward);
					  if(row==null){
						   row = sheet.createRow((short) (tmpAward));
						   row.setHeight((short) 400);
					...
					cell = row.createCell((short) 96);cell.setCellValue( award.getAwardDate()!= null ? Formater.formatDate(award.getAwardDate(), "yyyy-MM-dd")  :"-");cell.setCellStyle(style2);
					cell = row.createCell((short) 97);cell.setCellValue( award.getTitle()!= null ? award.getTitle() :"-");cell.setCellStyle(style2);
					tmpAward=tmpAward+1;
                 }
             }
              ...
              */
            //if(adaListFamily){
              if(tmpAward-countRow > addRow){
                     addRow = tmpAward - countRow;
             }
             ...
             if(listExpericen!=null && listExpericen.size()>0){
                 for(int idxExp=0; idxExp<listExpericen.size();idxExp++){
                     Experience  empExperience = (Experience)listExpericen.get(idxExp);
					  ...
					  cell = row.createCell((short) 98);cell.setCellValue( !empExperience.getPosition().isEmpty() ? empExperience.getPosition()  :"-");cell.setCellStyle(style2);
					  cell = row.createCell((short) 99);cell.setCellValue( !empExperience.getCompanyName().isEmpty() ? empExperience.getCompanyName()  :"-");cell.setCellStyle(style2);
					  cell = row.createCell((short) 100);cell.setCellValue( empExperience.getStartDate() >0 ? ""+empExperience.getStartDate()  :"-");cell.setCellStyle(style2);
					  cell = row.createCell((short) 101);cell.setCellValue( empExperience.getEndDate( )>0 ? ""+empExperience.getEndDate()  :"-");cell.setCellStyle(style2);
...
*/
		...
		for (int i=2; i < 98;i++){
		 ...
		 if (sheet.getColumnWidth(i)>12000){
			 Integer sh_object = new Integer(12000); 
			 sheet.setColumnWidth(i, sh_object.shortValue());
		 }
	 }
