...
public class SalaryChangeXLS extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String[] tableHeaderItem = {
            "No", "Payroll Num","Commencing Date", "Full Name",
        ...
        if (listSalaryChange != null && listSalaryChange.size() > 0) {
            for (int i = 0; i < listSalaryChange.size(); i++) {
                ...
                Employee objEmployee = (Employee) PstEmployee.getEmployeeByNum(salaryChange.getPayrollNumber());
                countRow++;
                no++;
                ...
                cell.setCellValue(Formater.formatDate( objEmployee.getCommencingDate(),"yyyy-MM-dd"));
                cell.setCellStyle(style2);
