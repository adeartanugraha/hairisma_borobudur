...
public class WarningListXLS extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String[] tableHeaderEng = {
            "NO", "PAYROLL", "EMPLOYEE", "DEPARTMENT", "POSITION", "DATE","VALID UNTUL", "FACTS", "WARN BY"
        };
        
        String[] tableHeaderID = {
            "NO", "NRK", "Nama Karyawan", "Unit", "Jabatan", "Tanggal","Berlaku Sampai", "Deskripsi", "Diberikan Oleh"
        };
        ...
        for (int i = 0; i < listSource.size(); i++) {
            ...
            cell.setCellValue(Formater.formatDate(wrn.getValidityDate(), "d-MMM-yyyy"));
            cell.setCellStyle(styleTop);
