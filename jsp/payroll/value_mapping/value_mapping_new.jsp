...
<%
    ...
    long s_period = FRMQueryString.requestLong(request, "s_period");
     ...
     s_remark = FRMQueryString.requestInt(request, "s_remark");
     }
...
<html>
    <head>
        ...
        <script type="text/javascript">
           function loadList(grade_code, comp_code,s_companyId,s_divisionId,s_departmentId,s_sectionId,s_levelId,s_empcatId,s_positionId,s_gradeId ,s_empId,s_maritalId,s_religionId,s_value,s_type,s_period,s_remark) {
                ...
                xmlhttp.open("GET", "list-valuemap-ajax.jsp?grade_code=" + grade_code + "&comp_code="+comp_code+ "&s_company_id="+s_companyId+ "&s_division_id="+s_divisionId+ "&s_department_id="+s_departmentId+ "&s_section_id="+s_sectionId+ "&s_level_id="+s_levelId+ "&s_empcat_id="+s_empcatId+ "&s_position_id="+s_positionId+ "&s_grade_id="+s_gradeId+ "&s_emp_id="+s_empId+ "&s_marital_id="+s_maritalId+ "&s_value="+s_value+ "&s_type="+s_type+ "&s_period="+s_period+"&s_remark="+s_remark, true);
                xmlhttp.send();
                
            }
            
            function prepare(comp_code, oid_value_mapping,s_companyId,s_divisionId,s_departmentId,s_sectionId,s_levelId,s_empcatId,s_positionId,s_gradeId ,s_empId,s_maritalId,s_religionId,s_value,s_type,s_period,s_remark){
                loadList("0", comp_code,s_companyId,s_divisionId,s_departmentId,s_sectionId,s_levelId,s_empcatId,s_positionId,s_gradeId ,s_empId,s_maritalId,s_religionId,s_value,s_type,s_period,s_remark);
                pageLoad();
                loadCompany(oid_value_mapping);
                s_loadCompany(oid_value_mapping,s_companyId,s_divisionId,s_departmentId,s_sectionId);
            }
            
            function cmdListFirst(start, comp_code,s_companyId,s_divisionId,s_departmentId,s_sectionId,s_levelId,s_empcatId,s_positionId,s_gradeId ,s_empId,s_maritalId,s_religionId,s_value,s_type,s_period,s_remark){                
                var xmlhttp = new XMLHttpRequest();
                xmlhttp.onreadystatechange = function() {
                    if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                        document.getElementById("div_respon").innerHTML = xmlhttp.responseText;
            ...
            function cmdListPrev(start, comp_code,s_companyId,s_divisionId,s_departmentId,s_sectionId,s_levelId,s_empcatId,s_positionId,s_gradeId ,s_empId,s_maritalId,s_religionId,s_value,s_type,s_period,s_remark){
                var xmlhttp = new XMLHttpRequest();
                xmlhttp.onreadystatechange = function() {
                    if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                        document.getElementById("div_respon").innerHTML = xmlhttp.responseText;
            ...
            function cmdListNext(start, comp_code,s_companyId,s_divisionId,s_departmentId,s_sectionId,s_levelId,s_empcatId,s_positionId,s_gradeId ,s_empId,s_maritalId,s_religionId,s_value,s_type,s_period,s_remark){
                var xmlhttp = new XMLHttpRequest();
                xmlhttp.onreadystatechange = function() {
                    if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                        document.getElementById("div_respon").innerHTML = xmlhttp.responseText;
            ...
            function cmdListLast(start, comp_code,s_companyId,s_divisionId,s_departmentId,s_sectionId,s_levelId,s_empcatId,s_positionId,s_gradeId ,s_empId,s_maritalId,s_religionId,s_value,s_type,s_period,s_remark){
                var xmlhttp = new XMLHttpRequest();
                xmlhttp.onreadystatechange = function() {
                    if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                        document.getElementById("div_respon").innerHTML = xmlhttp.responseText;
    ...
    <body onload="prepare('<%=compCode%>','<%=oidValueMapping%>','<%=s_companyId%>','<%=s_divisionId%>','<%=s_departmentId%>','<%=s_sectionId%>','<%=s_levelId%>','<%=s_empcatId%>','<%=s_positionId%>','<%=s_gradeId %>','<%=s_empId%>','<%=s_maritalId%>','<%=s_religionId%>','<%=s_value%>','<%=s_type%>','<%=s_period%>','<%=s_remark%>')">
        <div class="header">
        ...
        <div class="content-main">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td valign="top" style="padding-left: 21px">
                                ...
                                <div class="divinput">
                                    <select name="s_remark">
                                        <option  value="-1">Select</option>
                                        <%
                                        
                                        for(int s=0; s < PstValue_Mapping.getRemarkString.length ; s++){
                                            if (s_remark == s){
                                            %>
                                            <option selected="selected" value="<%=s%>"><%=PstValue_Mapping.getRemarkString[s]%></option>
                                            <%
                                            } else {
                                            %>
                                            <option value="<%=s%>"><%=PstValue_Mapping.getRemarkString[s]%></option>
                                            <%
                                            }
                                        }
                                        %>
            ...
            if (iCommand == Command.ADD || iCommand == Command.EDIT){
				...
				<div class="caption">Remark</div>
                                <div class="divinput">
                                    <select name="<%=FrmValue_Mapping.fieldNames[FrmValue_Mapping.FRM_FIELD_REMARK]%>" >
                                        <option value="0" <%=valueMapping.getRemark() == 0 ? "selected":""%>>New Employee</option>
                                        <option value="1" <%=valueMapping.getRemark() == 1 ? "selected":""%>>Transfer</option>
                                        <option value="2" <%=valueMapping.getRemark() == 2 ? "selected":""%>>Promotion</option>
                                        <option value="3" <%=valueMapping.getRemark() == 3 ? "selected":""%>>General Increase</option>
                                        <option value="4"<%=valueMapping.getRemark() == 4 ? "selected":""%>>Yearly Increase</option>
                                        <option value="5"<%=valueMapping.getRemark() == 5 ? "selected":""%>>Demotion</option>
                                        <option value="6"<%=valueMapping.getRemark() == 6 ? "selected":""%>>Adjustment</option>
                                        <option value="7"<%=valueMapping.getRemark() == 7 ? "selected":""%>>Re-Contract</option>
                                        <option value="8"<%=valueMapping.getRemark() == 8 ? "selected":""%>>Extended Contract</option>
