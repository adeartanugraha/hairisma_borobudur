...
<%
    ...
    int s_remark = FRMQueryString.requestInt(request, "s_remark");
    ...
    //add by eri yudi 20200831
     if (s_remark != -1){
        whereClause += " AND vm." + PstValue_Mapping.fieldNames[PstValue_Mapping.FLD_REMARK]+" = "+s_remark+" ";
    }
    //end
    ...
    if (listValueMap != null && listValueMap.size()>0){
        ...
        for(int i=0; i<listValueMap.size(); i++){
            ...
            <tr>
                ...
                <td><%=PstValue_Mapping.getRemarkString[valueMapping.getRemark()]%></td>
                <td>
        ...
        <div class="pagging">
            <a style="color:#F5F5F5" href="javascript:cmdListFirst('<%=start%>','<%=compCode%>','<%=s_companyId%>','<%=s_divisionId%>','<%=s_departmentId%>','<%=s_sectionId%>','<%=s_levelId%>','<%=s_empcatId%>','<%=s_positionId%>','<%=s_gradeId %>','<%=s_empId%>','<%=s_maritalId%>','<%=s_religionId%>','<%=s_value%>','<%=s_type%>','<%=s_period%>','<%=s_remark%>')" class="btn-small">First</a>
            <a style="color:#F5F5F5" href="javascript:cmdListPrev('<%=start%>','<%=compCode%>','<%=s_companyId%>','<%=s_divisionId%>','<%=s_departmentId%>','<%=s_sectionId%>','<%=s_levelId%>','<%=s_empcatId%>','<%=s_positionId%>','<%=s_gradeId %>','<%=s_empId%>','<%=s_maritalId%>','<%=s_religionId%>','<%=s_value%>','<%=s_type%>','<%=s_period%>','<%=s_remark%>')" class="btn-small">Previous</a>
            <a style="color:#F5F5F5" href="javascript:cmdListNext('<%=start%>','<%=compCode%>','<%=s_companyId%>','<%=s_divisionId%>','<%=s_departmentId%>','<%=s_sectionId%>','<%=s_levelId%>','<%=s_empcatId%>','<%=s_positionId%>','<%=s_gradeId %>','<%=s_empId%>','<%=s_maritalId%>','<%=s_religionId%>','<%=s_value%>','<%=s_type%>','<%=s_period%>','<%=s_remark%>')" class="btn-small">Next</a>
            <a style="color:#F5F5F5" href="javascript:cmdListLast('<%=start%>','<%=compCode%>','<%=s_companyId%>','<%=s_divisionId%>','<%=s_departmentId%>','<%=s_sectionId%>','<%=s_levelId%>','<%=s_empcatId%>','<%=s_positionId%>','<%=s_gradeId %>','<%=s_empId%>','<%=s_maritalId%>','<%=s_religionId%>','<%=s_value%>','<%=s_type%>','<%=s_period%>','<%=s_remark%>')" class="btn-small">Last</a>
        </div>
        <%
    } else {
        %>
