...
<%!    public String drawList(int iCommand, FrmPayEmpLevel frmObject, PayEmpLevel objEntity, Vector objectClass, long payEmpLevelId, int st, int jumlah, int periodBln, int periodThn, boolean booleanGenerate, long periodId, boolean booleanGenerateAll) {
                                                                                            ...
                                                                                            <td height="13" colspan="5">
                                                                                                ...
                                                                                                //System.out.println("listEmployee "+listEmployee.size());%>
                                                                                                    <tr> 
                                                                                                        ...
                                                                                                        <td   width="100%" colspan="6" height="8"><%=drawList(iCommand, frmPayEmpLevel, payEmpLevel, listEmployee, oidPayEmpLevel, start, countList, periodBln, periodThn, booleanGenerate, periodId, booleanGenerateAll)%></td>
                                                                                                    </tr>
                                                                                                    <%} else {%>
                                                                                                    <tr> 
