...
// proses calculate            
          if (iCommand == Command.START ) {
                    ...
                    listEmpLevel = PstPayEmpLevel.listEmpLevel(levelCode, levelSel, oidDepartment, payrollGroupId );
...
<tr> 
                ...
                <tr> 
                    <td width="1%">&nbsp;</td>
                    <!--<td colspan="4">&nbsp;</td>-->
                    <td colspan="4" nowrap >&nbsp; <%=PayProcessManager.getProgressSize()%> of <%=PayProcessManager.getRecordSize() %> ( <%=(PayProcessManager.getRecordSize()>0? ( Math.ceil(((float)PayProcessManager.getProgressSize())/((float)PayProcessManager.getRecordSize())*100f )) :0.0) %> % )</td>
                </tr>
                <tr> 
                    <td width="1%">&nbsp;</td>
                    <td colspan="4">&nbsp;
