...
<%
    ...
    if (iCommand == Command.CLOSE){
        ...
        Date dt = new Date();
        String whereClauseClose = whereClause + " AND "+PstPayConfigPotongan.fieldNames[PstPayConfigPotongan.FLD_END_DATE]+" < '"+Formater.formatDate(payPeriod.getEndDate(), "yyyy-MM-dd")+"'";
...
<script type="text/javascript">
    ...
    function cmdNonActiveAll(){
        ...
        document.frm.oidPeriod.value=document.getElementById("selPeriod").value;
        document.frm.action="config_potongan.jsp";
        document.frm.submit();
    }
    function cmdBack(){
    ...
    <body onload="pageLoad()">
        ...
        <div class="content-main">
            <form name="frm" method="post" action="" >
                ...
                <input type="hidden" name="oidPeriod" value="0"/>
                ...
                <a style="color:#FFF;" class="btn" id="openModal">Non Active All Past Date</a>
                <div>&nbsp;</div>
        ...
        <div id="myModal" class="modal">
          ...
          <div class="modal-content">
            ...
            <div class="caption">Payroll Periode</div>
            <div class="divinput">
                <select name="src_non_active_period" id="selPeriod">
                        <option value="0">-select-</option>
                        <%
                            Vector listPayPeriod = PstPayPeriod.list(0, 0, "", PstPayPeriod.fieldNames[PstPayPeriod.FLD_START_DATE] + " DESC");
            ...
            <div>&nbsp;</div>
            <a style="color:#FFF;" class="btn" href="javascript:cmdNonActiveAll()">Non Aktif</a>
          </div>
            <script>
            // Get the modal
