...
<%
    ...
    if (iCommand == Command.LIST) {
        ...
        if (paramPayInput != null && paramPayInput.getsEmployeeId() != null && paramPayInput.getsEmployeeId().length() > 0 && paramPayInput.getPeriodId() != 0) {
            listPayInput = SessPayInput.listPayInput(departmentName, companyId, oidDivision, (levelCode), sectionName, searchNrFrom, searchNrTo, searchName, periodId, dataStatus, isChekedRadioButtonSearchNr, searchNr, payrollGroupId);
