...
<%!
    public String drawList(int iCommand, FrmPaySlipComp frmObject, PaySlipComp objEntity, Vector objectClass, long idPaySlipComp, String codeComponent, String componentName) {
        ...
        String link = "<a href=\"Javascript:SetAllCheckBoxes('frm_printing','print', true,"+maxList+")\">Set All</a> | "+
              "<a href=\"Javascript:SetAllCheckBoxes('frm_printing','print', false,"+maxList+")\">Release All</a>";     
        ...
        ctrlist.addHeader("Print <br>"+link);
        ...
        if (objectClass != null && objectClass.size() > 0) {
            for (int i = 0; i < objectClass.size(); i++) {
                ...
                rowx.add("<input type=\"checkbox\" name=\"print" + i + "\" value=\"" + employee.getOID() + "\" class=\"formElemen chkbx\" size=\"10\"><input type=\"hidden\" name=\"employeeId\" value=\"" + employee.getOID() + "\" class=\"formElemen\" size=\"10\">");
...
function cmdUpdateSec(){
 ...
 function cmdSearch(){
        ...
        function SetAllCheckBoxes(FormName, FieldName, CheckValue, maxList)
{
