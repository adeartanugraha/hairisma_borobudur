                                                       ...
                                                       <%
                                                        ...
                                                        try {
                                                            ...
                                                            try {
                                                                ...
                                                                percen5 = Double.parseDouble(PstSystemProperty.getValueByName("PAYROLL_percen_5").equalsIgnoreCase(PstSystemProperty.SYS_NOT_INITIALIZED) ? "0" : PstSystemProperty.getValueByName("PAYROLL_percen_5"));
                                                                ...
                                                                range4 = Double.parseDouble(PstSystemProperty.getValueByName("PAYROLL_range_4").equalsIgnoreCase(PstSystemProperty.SYS_NOT_INITIALIZED) ? "0" : PstSystemProperty.getValueByName("PAYROLL_range_4"));
                                                            } catch (Exception exc) {
