...
if(namaUser1.equals("Employee")){
    ...
    flyout.addMenuFlyOut("employee.jsp", "Employee", dictionaryD.getWord("LEAVE_APPLICATION"), true, "DP Management", "leave_application", "#", ""+approot+"/employee/attendance/dp.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
	...
	flyout.addMenuFlyOut("employee.jsp", "Employee", dictionaryD.getWord("LEAVE_APPLICATION"), true, "HL Management", "leave_application", "#", ""+approot+"/employee/attendance/hl.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
                 AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_EMPLOYEE, AppObjInfo.G2_MENU_LEAVE_APPLICATION, AppObjInfo.OBJ_MENU_DP_MANAGEMENT), 
                 AppObjInfo.COMMAND_VIEW)));
...
flyout.addMenuFlyOut("training.jsp", "Training", "Training Matters", true, dictionaryD.getWord(I_Dictionary.TRAINING_SEARCH), "training_search", "#", ""+approot+"/employee/training/search_training.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
...
flyout.addMenuFlyOut("training.jsp", "Training", "Training Matters", true, dictionaryD.getWord(I_Dictionary.TRAINING_HISTORY), "training_history", "#", ""+approot+"/employee/training/src_training_hist_hr.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
...
flyout.addMenuFlyOut("training.jsp", "Training", "Training Matters", true, "Training Master Data", "training_type", "#", ""+approot+"/masterdata/list_train_type.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_TRAINING, AppObjInfo.G2_TRAINING_TYPE, AppObjInfo.OBJ_MENU_TRAINING_TYPE), 
             AppObjInfo.COMMAND_VIEW)));
			 
flyout.addMenuFlyOut("training.jsp", "Training", "Training Matters", true, dictionaryD.getWord(I_Dictionary.TRAINING_PLAN), "training_plan", "#", ""+approot+"/employee/training/training_plan_list.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_TRAINING, AppObjInfo.G2_TRAINING_PLAN, AppObjInfo.OBJ_MENU_TRAINING_PLAN), 
             AppObjInfo.COMMAND_VIEW)));
			 
flyout.addMenuFlyOut("training.jsp", "Training", "Training Matters", true, "Actual Training", "training_actual", "#", ""+approot+"/employee/training/training_actual_list.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_TRAINING, AppObjInfo.G2_TRAINING_ACTUAL, AppObjInfo.OBJ_MENU_TRAINING_ACTUAL), 
             AppObjInfo.COMMAND_VIEW)));
			 
flyout.addMenuFlyOut("training.jsp", "Training", "Training Matters", true, dictionaryD.getWord(I_Dictionary.TRAINING_TYPE), "training_program", "#", ""+approot+"/masterdata/srctraining.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_TRAINING, AppObjInfo.G2_TRAINING_PROGRAM, AppObjInfo.OBJ_MENU_TRAINING_PROGRAM), 
             AppObjInfo.COMMAND_VIEW)));
			 
flyout.addMenuFlyOut("training.jsp", "Training", "Training Matters", true, dictionaryD.getWord(I_Dictionary.TRAINING_VENUE), "training_venue", "#", ""+approot+"/masterdata/list_train_venue.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_TRAINING, AppObjInfo.G2_TRAINING_VANUE, AppObjInfo.OBJ_MENU_TRAINING_VANUE), 
             AppObjInfo.COMMAND_VIEW)));
			 
flyout.addMenuFlyOut("training.jsp", dictionaryD.getWord(I_Dictionary.TRAINING), "Training Matters", true, "Training Organizer Data", "training_organizer", "#", ""+approot+"/masterdata/contact/srccontact_list.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
             ...
             AppObjInfo.COMMAND_VIEW)));
flyout.addMenuFlyOut("training.jsp", dictionaryD.getWord(I_Dictionary.TRAINING), "Training Matters", true, "Training Organizer Type", "training_organizer", "#", ""+approot+"/masterdata/contact/contact_class.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_TRAINING, AppObjInfo.G2_TRAINING_ORGANIZER , AppObjInfo.OBJ_TRAINING_ORGANIZER_CONTACT ), 
             AppObjInfo.COMMAND_VIEW)));

flyout.addMenuFlyOut("training.jsp", dictionaryD.getWord(I_Dictionary.TRAINING), "Training Matters", true, "Import Training", "training_import", "#", ""+approot+"/employee/training/import_training.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_TRAINING, AppObjInfo.G2_TRAINING_IMPORT, AppObjInfo.OBJ_TRAINING_IMPORT), 
             AppObjInfo.COMMAND_VIEW)));
...
flyout.addMenuFlyOut("reports.jsp", "Reports", dictionaryD.getWord(I_Dictionary.PAYROLL), true, "Form 1721 A1 ", "payroll", "#", ""+approot+"/report/payroll/src_a1_1721.jsp",	userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_REPORTS, AppObjInfo.G2_MENU_PAYROLL_REPORT, AppObjInfo.OBJ_MENU_LIST_SALARY_SUMMARY_REPORT), 
             AppObjInfo.COMMAND_VIEW)));
