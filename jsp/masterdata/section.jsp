...
function cmdAddSectionLink(){
    ...
    document.getElementById("FRM_FIELD_SECTION_LINK_TO").value = result;
}
function fnTrapKD(){
	//alert(event.keyCode);
                                                  ...
                                                  <table border="0" cellspacing="2" cellpadding="2" width="50%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <input type="text" size="49"  id="<%=frmSection.fieldNames[FrmSection.FRM_FIELD_SECTION_LINK_TO]%>" name="<%=frmSection.fieldNames[FrmSection.FRM_FIELD_SECTION_LINK_TO]%>" value="<%=sectionData%>" size="70" />
                                                        </td>
                                                    </tr>
