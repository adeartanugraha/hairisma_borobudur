...
function cmdPrintXLS(){
    document.frmsrcemployee.command.value="<%=String.valueOf(Command.LIST)%>";
		document.frmsrcemployee.action="<%=approot%>/EmployeXlsNew";
		document.frmsrcemployee.submit();
    }
                                                  ...
                                                  <table border="0" cellspacing="2" cellpadding="2" width="72%">
                                                    ...
                                                    <tr align="left" valign="top">
                                                      ...
                                                      <td width="83%"> 
                                                           ...
                                                           //sementara
                                                           long depOid =0;
                                                            depOid = departmentOfLoginUser.getOID();
                                                           int SetHRD = 0 ;
                                                           try {
                                                    ...
                                                    <tr align="left" valign="top"> 
                                                      ...
                                                      <td width="83%"> 
                                                          ...
                                                          <%
                                                            ...
                                                            if (depOid==0 || depOid==SetHRD || isGeneralManager){
                                                                div_value.add("0");
                                                                div_key.add("select ...");
                                                            } else {
                                                      ...
                                                      <td width="83%"> 
                                                         <%
                                                          ...
                                                          Vector dept_value = new Vector(1,1);
                                                            ...
                                                            String strWhere="";
                                                            if (depOid==0 || depOid==SetHRD || divisionOid == sdmDivisionOid || isGeneralManager){
                                                               
                                                              strWhere = PstDepartment.TBL_HR_DEPARTMENT+"."+PstDepartment.fieldNames[PstDepartment.FLD_DIVISION_ID]+"="+lDivisionId;//oidDivision
                                                            } else {
                                                                if (divisionOid != 0){
                                                                    strWhere = PstDepartment.TBL_HR_DEPARTMENT+"."+PstDepartment.fieldNames[PstDepartment.FLD_DIVISION_ID]+"="+divisionOid;//oidDivision
                                                                } else {
                                                    ...
                                                    <tr align="left" valign="top"> 
                                                      ...
                                                      <td width="83%"> <table width="30%" border="0" cellspacing="0" cellpadding="0">
                                                          <tr> 
                                                            ...
                                                            <td width="2%"><img src="<%=approot%>/images/spacer.gif" width="6" height="1"></td>   
                                                            <td nowrap><a href="javascript:cmdPrintXLS()" class="command">Export Excel</a></td>
                                                             <td width="2%"><img src="<%=approot%>/images/spacer.gif" width="6" height="1"></td>                                                           
