                                        ...
                                        <td valign="top"> <!-- Left Side -->
                                            <div class="box">
                                                ...
                                                <table>
                                                        ...
                                                        <td valign="middle">
                                                            <%
                                                                ...
                                                                if (employee.getBirthDate() != null) {
                                                                    String empBirthDate = Formater.formatDate(employee.getBirthDate(), "yyyy-MM-dd");
                                                                    age = 0;//EmployeeDetailPdf.getAge(empBirthDate);
                                                                }

                                                            %>
                                                            <input type="text" readonly  value="<%=age%>" class="formElemen"> *Auto        
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <th valign="middle">No Kartu Keluarga</th>
                                                        <td valign="middle">
                                            ...
                                            <div class="box">
                                                <table>
                                                    ...
                                                    <tr>
                                                        <th valign="middle">Nama Rekening</th>
                                                        <td valign="top"><input type="text" name="<%=frmEmployee.fieldNames[FrmEmployee.FRM_FIELD_NAMA_REKENING]%>" class="formElemen" size="40" value="<%=employee.getNamaRekening()%>" /></td>
                                                    </tr>
                                                     <tr>
                                        ...
                                        <td valign="top"><!-- Right Side -->
                                            ...
                                            <div class="box">
                                                <table>
                                                    ...
                                                    <tr>
                                                        <th valign="middle">Length of Services</th>    
                                                        <td valign="middle">
                                                            <%
                                                            double los = 0;
                                                            if (employee.getCommencingDate()!=null){
                                                                Date dt = employee.getCommencingDate();
                                                                if (employee.getResignedDate() != null){
                                                                    dt = employee.getResignedDate();
                                                                }
                                                                long dayDiffLos = DateCalc.dayDifference(dt, new Date());
                                                                los = EmployeeDetailPdf.getLosValue(dayDiffLos+"/365");
                                                            }
                                                            %>
                                                            <input type="text" readonly value="<%=los%>" class="formElemen" >
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                            <div class="box">
                                                <table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td valign="middle">
                                                            <%=ControlDate.drawDateWithStyle(frmEmployee.fieldNames[FrmEmployee.FRM_FIELD_RESIGNED_DATE], employee.getResignedDate(), +5, -100, "formElemen")%>
                                                        </td>
                                                    </tr>
                                                    <tr>
