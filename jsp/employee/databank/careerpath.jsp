...
<!--list pada tabel riwayat jabatan-->
<%!    public String drawList(Vector objectClass, long workHistoryNowId, I_Dictionary dictionaryD, boolean privAdd, boolean privUpdate, boolean privDelete) {
        int index = -1;
        String output = "";
        String prevReason = "";
        for (int i = 0; i < objectClass.size(); i++) {
            ...
            if (careerPath.getHistoryGroup() == PstCareerPath.RIWAYAT_JABATAN) {
                ...
                if (SetLocation == 1) {
                    output += "<td>" + careerPath.getLocation() + "</td>";
                }
...
//                    output += "<td>-</td>";
//                }
                output += "<td>" + prevReason + "</td>";
                prevReason = careerPath.getDescription();
                if (privDelete == true) {
...
/*List table riwayat jabatan dan grade*/
...
<%!    public String drawListCurrent(Employee employee, Vector objectClass, I_Dictionary dictionaryD) {
        ...
        if (objectClass.size() > 0) {
            ...
            try {
                ...
                crReason = careerPath.getDescription();
            } catch (Exception e) {
                str_dt_WorkFrom = "";
            }
            ...
            <form name="frmcareerpath" method ="post" action="careerpath.jsp">
                ...
                <div class="content">
                    ...
                    <table class="tblStyle">
                        ...
                        <!-- code untuk head table daftar riwayat jabatan-->
                        <tr>
                            ...
                            <td class="title_tbl">Reason</td>
                            <%if (privDelete == true) {%>
                            <td class="title_tbl">&nbsp;</td>
                            <%}%>
                        </tr><br>
                        
                        <%= drawList(listCareerPath, iCommand == Command.SAVE ? careerPath.getOID() : oidCareerPath, dictionaryD, privAdd, privUpdate, privDelete)%>
                        ...
                        <tr>
                            <td width="100%" colspan="2">
                                <table border="0" cellspacing="2" cellpadding="2" width="100%">
                                    ...
                                    <!--Ayudian menambahkan field reason, pd tabel namanya description-->
                                    <tr>
                                        <td>Reason</td>
                                        <td colspan="4"><textarea name="<%=FrmCareerPath.fieldNames[FrmCareerPath.FRM_FIELD_DESCRIPTION]%>" class="elemenForm"><%= careerPath.getDescription()%></textarea></td>
                                    </tr> 
                                    <tr>
                                        <td colspan="2">
