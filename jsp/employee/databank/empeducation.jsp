...
<%!
...

	{
		...
		for (int i = 0; i < objectClass.size(); i++) {
			...
			rowx.add(eduString);
			rowx.add(empEducation.getInstitution());
...
<%
    ...
    String orderClause = PstEmpEducation.fieldNames[PstEmpEducation.FLD_END_DATE] + " DESC ";
                    ...
                    <%if((iCommand ==Command.ADD)||(iCommand==Command.SAVE)&&(frmEmpEducation.errorSize()>0)||(iCommand==Command.EDIT)){%>
                        ...
                        <div class="form-style" style="width: 35%">
                            ...
                            <div class="form-content">
                                ...
                                <div id="div_input">
                                    <input type="text" name="<%=frmEmpEducation.fieldNames[FrmEmpEducation.FRM_FIELD_INSTITUTION] %>" size="45"  value="<%= empEducation.getInstitution() %>" class="formElemen">
                                </div>
