...
<%!
	...
	if(objectList!=null && objectList.size()>0) {
            ...
            ctrlist.addHeader(listTitles[2],"15%"); 
...
Vector listReprimandAll = new Vector();
int vectSize;
...
if (iCommand == Command.LIST) {
        ...
        listReprimandAll = SessEmpReprimand.getEmployeeReprimand(srcReprimand, 0, vectSize);
        ...
        try {
            ...
            session.putValue("session_list", listReprimandAll);
