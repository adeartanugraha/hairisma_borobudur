...
<%!
    ...
    public String drawList(Vector<SrcEsptA1> objectClass) {
        ...
        for (int i = 0; i < objectClass.size(); i++) {
			...
			try {
				emp = PstEmployee.getEmployeeByNum(espt.getEmpNum());
			} catch (Exception exc){}

            
            rowx.add("<input type='hidden' name='EMPLOYEE_ID' value='"+emp.getOID()+"'><input type='hidden' name='TAHUN_PAJAK' value='"+(espt.getTahunPajak().getYear()+1900)+"'>" + no); //1
...
<html>
    <head>
        ...
        <script type="text/javascript">
			...
			function cmdSearchDetail(){ 
                document.frm_src_espt.command.value="<%=Command.LIST%>";
                document.frm_src_espt.action="src_espt_A1.jsp?search=2";
                document.frm_src_espt.submit();
            }
			
			function cmdDetailExcel(){ 
                document.frm_src_espt.command.value="<%=Command.LIST%>";
                document.frm_src_espt.action="export_excel/excel_espt_A1.jsp?search=2";
                document.frm_src_espt.submit();
            }
			...
			function cmdProccess(search){
				document.frm_src_espt.command.value="<%=Command.SAVE%>";
                document.frm_src_espt.action="<%=approot%>/A11721";
                document.frm_src_espt.submit();
			}
                                    ...
                                    <tr>
                                        <td style="background-color:#EEE;" valign="top">
                                            ...
                                            <table style="padding:9px; border:1px solid #00CCFF;" <%=garisContent%> width="100%" border="0" cellspacing="1" cellpadding="1" class="tablecolor">
                                                            ...
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    <td valign="top" id="tdForm" colspan="2">
																		...
																		<button id="btn" onclick="javascript:cmdSearchDetail()">Detail</button>&nbsp;
                                                                        <button id="btn" onclick="javascript:cmdDetailExcel()">Export to Excel Detail</button>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                    </td>
                                                ...
                                                <tr>
                                                    <%
                                                    if (listEspt != null && listEspt.size()>0 && search != 2){
                                                    %>
                                                    <td>
													...
													%>
												<table class="tblStyle" width="100%" cellspacing="0" border="0">
													<tbody>
														<tr>
															<td class="title_tbl" width="" rowspan="2">No.</td>
															<td class="title_tbl" width="" rowspan="2">Emp Num</td>
															<td class="title_tbl" width="" rowspan="2">Unit Kerja</td>
															<td class="title_tbl" width="" rowspan="2">Mulai Kerja</td>
															<td class="title_tbl" width="" rowspan="2">Berhenti Kerja</td>
															<td class="title_tbl" width="" rowspan="2">Masa Pajak</td>
															<td class="title_tbl" width="" rowspan="2">Tahun</td>
															<td class="title_tbl" width="" rowspan="2">Pembetulan</td>
															<td class="title_tbl" width="" rowspan="2">Nomor Bukti Potong</td>
															<td class="title_tbl" width="" rowspan="2">Masa Perolehan Awal </td>
															<td class="title_tbl" width="" rowspan="2">Masa Perolehan Akhir</td>
															<td class="title_tbl" width="" rowspan="2">NPWP</td>
															<td class="title_tbl" width="" rowspan="2">NIK</td>
															<td class="title_tbl" width="" rowspan="2">Nama</td>
															<td class="title_tbl" width="" rowspan="2">Alamat</td>
															<td class="title_tbl" width="" rowspan="2">Jenis Kelamin</td>
															<td class="title_tbl" width="" rowspan="2">Status PTKP</td>
															<td class="title_tbl" width="" rowspan="2">Jumlah Tanggungan</td>
															<td class="title_tbl" width="" rowspan="2">Nama Jabatan</td>
															<td class="title_tbl" width="" rowspan="2">WP Luar Negeri</td>
															<td class="title_tbl" width="" rowspan="2">Kode Negara</td>
															<td class="title_tbl" width="" rowspan="2">Kode Pajak</td>
															<td class="title_tbl" width="" style="text-align: center" colspan="<%=periodList.size()+1%>">Jumlah 1</td>
															<td class="title_tbl" width="" style="text-align: center" colspan="<%=periodList.size()+1%>">Jumlah 2</td>
															<td class="title_tbl" width="" style="text-align: center" colspan="<%=periodList.size()+1%>">Jumlah 3</td>
															<td class="title_tbl" width="" style="text-align: center" colspan="<%=periodList.size()+1%>">Jumlah 4</td>
															<td class="title_tbl" width="" style="text-align: center" colspan="<%=periodList.size()+1%>">Jumlah 5</td>
															<td class="title_tbl" width="" style="text-align: center" colspan="<%=periodList.size()+1%>">Jumlah 6</td>
                                                                                                                        <td class="title_tbl" width="" style="text-align: center" colspan="<%=periodList.size()+1%>">Jumlah 7</td>
															<td class="title_tbl" width="" style="text-align: center" colspan="<%=periodList.size()+1%>">Jumlah 8</td>
<!--															<td class="title_tbl" width="" rowspan="2">Jumlah 8</td>-->
															<td class="title_tbl" width="" rowspan="2">Jumlah 9</td>
															<td class="title_tbl" width="" style="text-align: center" colspan="<%=periodList.size()+1%>">Jumlah 10</td>
															<td class="title_tbl" width="" rowspan="2">Jumlah 11</td>
															<td class="title_tbl" width="" rowspan="2">Jumlah 12</td>
															<td class="title_tbl" width="" rowspan="2">Jumlah 13</td>
															<td class="title_tbl" width="" rowspan="2">Jumlah 14</td>
															<td class="title_tbl" width="" rowspan="2">Jumlah 15</td>
															<td class="title_tbl" width="" rowspan="2">Jumlah 16</td>
															<td class="title_tbl" width="" rowspan="2">Jumlah 17</td>
															<td class="title_tbl" width="" rowspan="2">Jumlah 18</td>
															<td class="title_tbl" width="" rowspan="2">Jumlah 19</td>
															<td class="title_tbl" width="" style="text-align: center" colspan="<%=periodList.size()+1%>">Jumlah 20</td>
															<td class="title_tbl" width="" rowspan="2">Status Pindah</td>
															<td class="title_tbl" width="" rowspan="2">NPWP Pemotong</td>
															<td class="title_tbl" width="" rowspan="2">Nama Pemotong</td>
															<td class="title_tbl" width="" rowspan="2">Tanggal Bukti Potong</td>
														</tr>
														<tr>
															<%
												...
												<tr>
                                                    <td valign="top" id="tdForm" colspan="2">
														<button id="btn" onclick="javascript:cmdProccess('<%=search%>')">Proses A1</button>&nbsp;
													</td>
                                                </tr>
												<%
												}
