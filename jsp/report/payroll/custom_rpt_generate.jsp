                                                        ...
                                                        */
                                                        ...
                                                        if (listData != null && listData.size() > 0){
                                                            ...
                                                            for(int i=0;i<listData.size(); i++){
                                                                ...
                                                                System.out.println(" Test Debug :"+rpt.getRptConfigFieldName());
                                                                System.out.println(" Test Debug :"+rpt.getOID());
                                                                if(rpt.getOID() == 504404810091338409l){
                                                                    System.out.println("Masuk Debug");
                                                                }
