                                                        ...
                                                        <form name="frm_src_espt" method="POST" action="">
                                                            ...
                                                            <table>
                                                                ...
                                                                <tr align="left" valign="top"> 
                                                                  ...
                                                                  <td width="83%"> 
                                                                    <input type="radio" name="inp_resignStatus" value="0" <%= inp_resignStatus == 0 && iCommand == Command.LIST  ? "checked":""%>>
                                                                    <%=dictionaryD.getWord("NO")%> 
                                                                    <input type="radio" name="inp_resignStatus" value="1" <%= inp_resignStatus == 1 && iCommand == Command.LIST  ? "checked":""%>>
                                                                    <%=dictionaryD.getWord("YES")%>
                                                                    <input type="radio" name="inp_resignStatus" value="2" <%= inp_resignStatus == 2 && iCommand == Command.LIST ? "checked":""%> <%= iCommand != Command.LIST ? "checked":""%>>
                                                                    <%=dictionaryD.getWord(I_Dictionary.ALL)%> This Period 
                                                                    <input type="radio" name="inp_resignStatus" value="3" <%= inp_resignStatus == 3 && iCommand == Command.LIST  ? "checked":""%>>
