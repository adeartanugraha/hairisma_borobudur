                    ...
                    <table width="100%" border="0" cellspacing="3" cellpadding="2" id="tbl0">
                        <tr> 
                            <td width="100%" colspan="3" valign="top" style="padding: 12px"> 
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr> 
                                        <td height="20"> <div id="menu_utama">Salary Movement Report</div> </td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                    </tr>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <form name="frm" method="post" action="">
                                                            ...
                                                            <div id="mn_utama">Search Movement Change</div>
                                                            <table>
                                                                <%
                                                                    /*
                                                                ...
                                                                <tr>
                                                                    <td valign="top" id="tdForm">Periode</td>
                                                                    <td valign="top" id="tdForm">
                                                                        <%   //priska 20150730
                                                                            ...
                                                                            %>
                                                                             ...
                                                                             <%=ControlCombo.draw("periodFrom", null, "", period_value, period_key, "")%> To 
                                                                             <%=ControlCombo.draw("periodTo", null, "", period_value, period_key, "")%>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td valign="top" id="tdForm">Mutation Type</td>
                                                                    <td valign="top" id="tdForm">
                                                                        <select name="mutation_type" id="mutation_type">
                                                                             <option value="-1">All</option>
                                                                        <%
                                                                            for (int i=0; i < PstValue_Mapping.getRemarkString.length; i++){
                                                                            %>
                                                                            <option value="<%=String.valueOf(i)%>"><%=PstValue_Mapping.getRemarkString[i]%></option>
                                                                            <%
                                                                            }
