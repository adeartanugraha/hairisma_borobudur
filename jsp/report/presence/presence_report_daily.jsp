...
<%!    int DATA_NULL = 0;
    ...
    //add By Eri Yudi 2022-05-30
    /**
     * get working duration break of actual break In and break Out presence
     * @param dtActualIn => date break actual IN 
     * @param dtActualOut => date break actual OUT  
     * @return String of working duration in Hour and Minutes format 
     */
    public String getWorkingBreakDuration(Date dtActualIn, Date dtActualOut ) {
        String result = "";
        Date x = new Date();
    ...
    public Vector drawList(JspWriter outObj,int iCommand,Vector listAttendanceRecordDailly, Vector listPresencePersonalInOut,Vector listOvertimeDaily,HolidaysTable holidaysTable,  Date selectDateFrom, Date selectDateTo,String fullName,String empNum,boolean privUpdatePresence,int start,int showOvertime,boolean isHRDLogin,I_Atendance attdConfig,Vector vOvertimeDetail,boolean DepAdmin, int editscheduleAfter, int editScheduleBefore) {
      ...
      if(attdConfig!=null && attdConfig.getConfigurasiReportScheduleDaily()==I_Atendance.CONFIGURASI_I_REPORT_DAILY_SCHEDULE_AND_CEK_BOX_ADA_DIBELAKANG){
          ctrlist.setMaxFreezingTable(11);  
          ctrlist.addHeader("No", "1%", "2", "0");
            ...
            //harusnya
            ctrlist.addHeader("Duration", "2%", "2", "0");
        ctrlist.addHeader("Duration"+"<br>"+"Break", "2%", "2", "0");
          ...
          if(showOvertime==0){ 
            ...
            double beforeDays =  editScheduleBefore/24;
            double afterDays =  editscheduleAfter/24;
      
            Date deadDayBefore = new Date();
            Date deadDayAfter = new Date();
            
            deadDayBefore.setHours(deadDayBefore.getHours() - editScheduleBefore);
            deadDayAfter.setHours(deadDayAfter.getHours() + editscheduleAfter);
               ...
               // HolidaysTable holidaysTable = PstPublicHolidays.getHolidaysTable(selectedDateFrom, selectedDateTo); 
                ...
                //update by satrya 2012-10-10 
                 ...
                 Hashtable hashCekTanggalSamaBreak = new Hashtable();
                  Date dateBreakOut=null; 
                  Date dateBreakIn=null;
                         ...
                         if(presenceBreak.getEmployeeId()==presenceReportDaily.getEmpId() && presenceBreak.getPresenceDatetime()!=null 
                             ...
                             if(presenceBreak.getStatus()== Presence.STATUS_OUT_PERSONAL){
                                 ...
                                 //update by satrya 2013-07-28
                                  ...
                                  dateBreakOut = dtpresenceDateTime; 
                                  ...
                                  //istirahat terlamabat 
                                   ...
                                   dateBreakIn = presenceBreak.getPresenceDatetime();
                                 if(preBreakOut !=0L){   
                                  //update by satrya 2012-09-27
                                    //if(presenceBreak.getScheduleDatetime()==null || presenceBreak.getPresenceDatetime().getTime() > presenceBreak.getScheduleDatetime().getTime()){
                                     //update by satrya 2013-07-28\
                                 ...
                                 // diffBi = diffBi+ (presenceBreak.getScheduleDatetime().getTime() - presenceBreak.getPresenceDatetime().getTime());
                                   ...
                                   dateBreakOut = presenceBreak.getPresenceDatetime();
            ...
            //    int reasonv=0;
             ...
             //       reasonv = intAl;
              ...
              //   long periodId = PstPeriod.getPeriodIdBySelectedDate(presenceReportDaily.getSelectedDate());
                    ...
                    String sSymbol =""; 
                        Date dtNow = presenceReportDaily.getSelectedDate();
                        dtNow.setHours(0);
                        if (dtNow.after(deadDayBefore) && dtNow.before(deadDayAfter)){
 ...
 + "                                         title =\""+strSchINOut+"&nbsp;["+sDtSchldBO1st+"&nbsp;"+sDtSchldBI1st+"]\">"+" / <B>"+sSymbolLeave+"</B>"
                          ...
                          sSymbol="<input class=\"masterTooltip\" onblur=\"javascript:checkSymbol(this)\" type=\"text\"  id=\"inputName\" name=\"" + inputName+ "_symbol\" value=\"" + strSchldSymbol1 !=null || strSchldSymbol1.length() > 0 ? strSchldSymbol1.toUpperCase() : ""+0 + "\"  size=\"3\" "
                            ...
                            if(strSchldSymbol1 !=null && strSchldSymbol1.length() >0){
                                if(Al_oid != presenceReportDaily.getScheduleId1() && LL_oid != presenceReportDaily.getScheduleId1() && DP_oid != presenceReportDaily.getScheduleId1()){
                                  if(iLeaveMinuteEnable !=1){
                                  sSymbol ="<input class=\"masterTooltip\" onblur=\"javascript:checkSymbol(this)\" type=\"hidden\"   id=\"inputName\" name=\"" + inputName + "_symbol\" value=\"" + strSchldSymbol1.toUpperCase() + "\"  size=\"2\" "
                                        + "title =\""+strSchINOut+"&nbsp;["+sDtSchldBO1st+"&nbsp;"+sDtSchldBI1st+"]\"><p title =\""+strSchINOut+"&nbsp;["+sDtSchldBO1st+"&nbsp;"+sDtSchldBI1st+"] \">"+strSchldSymbol1.toUpperCase()+"</p>"
                                         ;// +"<a href=\"#\" id=\"clueTipBox\" class=\"clueTipBox\" title=\"Title Text|This box will open when text box get focus OR mouse hover on 'Hint' text.\">Hint</a>";
                                        
                                    }else{  
                                      if(sSymbolLeave !=null && sSymbolLeave.length() > 0){
                                          sSymbol ="<input class=\"masterTooltip\" onblur=\"javascript:checkSymbol(this)\" type=\"hidden\"  id=\"inputName\" name=\"" + inputName + "_symbol\" value=\"" + strSchldSymbol1.toUpperCase() + "\"  size=\"2\" "
                                            + "title =\""+strSchINOut+"&nbsp;["+sDtSchldBO1st+"&nbsp;"+sDtSchldBI1st+"]\">"+"<p title =\""+strSchINOut+"&nbsp;["+sDtSchldBO1st+"&nbsp;"+sDtSchldBI1st+"]\">"+ strSchldSymbol1.toUpperCase() +"</p>"+" / <B> - "+sSymbolLeave+"</B>"
                                                  ;
              //                            int successUpd = PstEmpSchedule.updatereasonnew(periodId, lEmpId, reason, reasonv);                                                  
                                  ...
                                  sSymbol = strSchldSymbol1 ;
                                    ...
                                    {
                                     sSymbol ="<input class=\"masterTooltip\" onblur=\"javascript:checkSymbol(this)\" type=\"hidden\"  id=\"inputName\" name=\"" + inputName + "_symbol\" value=\"" + strSchldSymbol1.toUpperCase() + "\"  size=\"3\" "
 + "                                         title =\""+strSchINOut+"&nbsp;["+sDtSchldBO1st+"&nbsp;"+sDtSchldBI1st+"]\">"+" <p title =\""+strSchINOut+"&nbsp;["+sDtSchldBO1st+"&nbsp;"+sDtSchldBI1st+"]\">"+ strSchldSymbol1.toUpperCase() +"</p>"+" / <B> - "+sSymbolLeave+"</B>"
                                            ;//  +"<a href=\"#\" id=\"clueTipBox\" class=\"clueTipBox\" title=\"Title Text|This box will open when text box get focus OR mouse hover on 'Hint' text.\">Hint</a>";
                                    }
                             }
                            } else {
                                sSymbol="<input class=\"masterTooltip\" onblur=\"javascript:checkSymbol(this)\" type=\"hidden\"  id=\"inputName\" name=\"" + inputName+ "_symbol\" value=\"" + strSchldSymbol1 !=null || strSchldSymbol1.length() > 0 ? strSchldSymbol1.toUpperCase() : ""+0 + "\"  size=\"3\" "
                                    + "title =\""+"-"+"&nbsp;["+"00:00"+"&nbsp;"+"00:00"+"]\"><p title =\""+strSchINOut+"&nbsp;[00:00 &nbsp; 00:00]\">"+ strSchldSymbol1.toUpperCase() +"</p>";
                            }
                        }
                  //mencari sSymbol2nd
                        String sSymbol2nd =""; 
               ...
               if(attdConfig!=null && attdConfig.getConfigurasiReportScheduleDaily()==I_Atendance.CONFIGURASI_I_REPORT_DAILY_SCHEDULE_AND_CEK_BOX_ADA_DIBELAKANG){    
                ...
                rowx.add(strEmpFullName);
                 ...
                 //end duration
                  ...
                  //untuk Duration break add by Eri Yudi 2022-05-30
                 String strDurationBreak = getWorkingBreakDuration(dateBreakOut,dateBreakIn);
                 if(strDurationBreak !=null && strDurationBreak.length() > 0){
                     rowx.add(strDurationBreak.indexOf("-")>-1 ? "<font color=\"#CC0000\"><center>"+strDurationBreak+"</center></font>" :"<font color=\"#000000\"><B><center>"+strDurationBreak+"</center></B></font>" ); //untuk durasi break
                 }else{
                       rowx.add("<font color=\"#CC0000\">"+"-"+"</font>");
                 }
                 //end duration
    ...
    if (iCommand == Command.SAVE || iCommand == Command.POST || iCommand==Command.FIRST || iCommand==Command.NEXT || iCommand==Command.PREV || iCommand==Command.LAST || iCommand==Command.LIST) {
        ...
        if (userSelect != null && userSelect.length > 0) {
          ...
          //update by priska 2015-03-05
                       ...
                       //hide by eri yudi 20200904 for generate dp dkph by level
...
//                       }
                       ...
                       //add by Eri Yudi 20200907 for Generate dp 
                       PresenceAnalyser presenceAnalyser = new PresenceAnalyser();
                      EmpSchedule empSch = (EmpSchedule) PstEmpSchedule.fetchExc(oidScheduleEmp);
                      long schduleId = empSch.getD(dateSelect);
                      ScheduleSymbol schSymbolEmp = (ScheduleSymbol) PstScheduleSymbol.fetchExc(schduleId);
                      ScheduleCategory schCat = (ScheduleCategory) PstScheduleCategory.fetchExc(schSymbolEmp.getScheduleCategoryId());
//                   
//                        int presenceStatus = PstEmpSchedule.getStatus1WithInAndOut(date, employeeId, period.getOID());
                      long genDp = presenceAnalyser.fungsiDPRamaResto(dtSelect,empSch.getEmployeeId(), schCat.getCategoryType());
                   //PresenceAnalyser.analyzePresencePerEmployeeByEmployeeId(dtSelect, employeeIdSelect);
